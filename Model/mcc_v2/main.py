...
from discrepancy_clustering_v3 import DiscrepancyClustering
...
class MCClassifier(object):
    ...
    def train(self, train_data_list, train_label_list, stop_criterion, max_centers=30, early_save=0, \
        save_name="early_save.sav"):
        print("start training")
        self.instances = self._instantiate(train_data_list, train_label_list)
        ...
        plt_centers_thresholds_cluster(1, self.instances, self.centers, self.thres)
